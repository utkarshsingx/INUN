    ...
    >
      <div className="mx-auto max-w-5xl">
        <StaggeredBlock className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-stone-600 sm:mt-6 sm:text-lg dark:text-zinc-400">
            {messages.aiIntro}
          </p>
        </StaggeredBlock>
        <motion.ul
        ...
        >
          {options.map((item) => (
            <motion.li
              ...
              className="card-surface card-surface-hover flex flex-col p-5 active:bg-stone-50/90 sm:p-6 dark:active:bg-white/10"
            >
